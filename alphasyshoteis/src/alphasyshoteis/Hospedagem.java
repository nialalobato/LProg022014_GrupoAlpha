...
public class Hospedagem {
    ...
    public Hospedagem(int id_hospedagem, int id_cliente, int id_quarto, Date data_entrada, Date data_saida, Time hora_entrada, Time hora_saida, Float valor_diaria, int quantidade_diaria, float total_hospedagem) {
    ...
    /**
     * @param quantidade_diaria the quantidade_diaria to set
     */
    ...
    /**
     * @param total_hospedagem the total_hospedagem to set
     */
